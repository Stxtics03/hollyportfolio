/**
 * Pond grid — the field of squares behind the tree.
 *
 ...
 * `createRng`. The algorithm is theirs.
 *
 * Every cell of the viewport gets a square on the same 8px grid as the tree,
 * in a randomised dark grey — the "empty contribution" cells. They brighten
 * near the cursor and lift in rings when you click.
 */
import { CELL_SIZE, SQUARE_SIZE, type TreeAnchor } from './treeConstants';
